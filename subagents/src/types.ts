...
export interface AgentRecord {
  ...
  /** Removes the parent abort listener installed while this record was queued. */
  queuedAbortCleanup?: () => void;
  groupId?: string;
  joinMode?: JoinMode;
  /** Set when an external consumer already consumed the result — suppresses the notification. */
